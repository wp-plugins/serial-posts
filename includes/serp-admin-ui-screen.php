...
<div class="wrap" id="sgr-style"><a name="top"></a>
	...
	<form method="post" action="options.php">
		...
		settings_fields('serp_plugin_settings_options'); ?>
		
		<?php $serp_options = get_option('serial_posts_settings'); // Load Options ?>
		
		<?php // Defines name for all add_settings_section() and add_settings_field()
		do_settings_sections('serial_posts_settings_sections'); ?>
